...
public unsafe class AudioBufferSink : MediaBufferSink
{
    ...
    public AudioFormat Format {
        get {
            int fmt = av_buffersink_get_format(Handle);
            int rate = av_buffersink_get_sample_rate(Handle);

            AVChannelLayout nativeLayout;
            av_buffersink_get_ch_layout(Handle, &nativeLayout);
...
public unsafe class VideoBufferSink : MediaBufferSink
{
    ...
    public PictureFormat Format {
        get {
            int fmt = av_buffersink_get_format(Handle);
            int width = av_buffersink_get_w(Handle);
            int height = av_buffersink_get_h(Handle);
            var pixelAspect = av_buffersink_get_sample_aspect_ratio(Handle);
